...
export default function Product() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get("/api/product/metallogo");
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="py-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">Metal Logos</h1>
                  <p className="text-sm text-gray-600 mt-1">Premium quality metal logo collection</p>
                </div>
              </div>
